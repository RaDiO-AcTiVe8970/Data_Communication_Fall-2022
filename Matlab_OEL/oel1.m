...
%% Encoding
i = round((x-min(x))/delta); % index for encoding
...
disp(['The converted bits from the input analog signal are:',num2str(x1),' ',num2str(x2),' ',num2str(x3)])